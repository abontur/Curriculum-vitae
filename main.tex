...
\section{Work Experience}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Software Engineer, Operations}{Jun 2021 \textbf{--} Present, Full-time}
        \resumeItemListStart
            \resumeItem{
              Working on automation tool for upgrading Postgres Database from 11.13 to 15
            }
            \resumeItem{
              Worked on toolkit (written in Jsonnet) for creating manifests for Kubernetes, Github Actions and Spinnaker pipelines during migration from Nomad to Kubernetes on DMZ
            }
        \resumeItemListEnd

    \resumeSubheading
      {Motorola Solutions}{Kraków, Poland}
      {Operations Engineer}{Jun 2019 \textbf{--} May 2021, Full-time}
        \resumeItemListStart
        \resumeItemListEnd
      {Linux Platform}
        \resumeItemListStart
          \resumeItem{Configured Continuous Integration/Continuous Deployment (CI/CD) systems, optimizing the development workflow and increasing operational efficiency}
          \resumeItem{Maintained existing scripts, ensuring their optimal performance and making necessary adjustments to accommodate changes in system requirements.}
          \resumeItem{}
        \resumeItemListEnd
      {Key Achievement}
        \resumeItemListStart
          \resumeItem{Successfully implemented Jenkins DSL with Configuration as Code (CASC) on a Docker system in the existing environment, significantly enhancing the automation and scalability of the CI/CD pipeline.}
        \resumeItemListEnd
      {Windows Platform}
        \resumeItemListStart
          \resumeItem{Configured CI/CD systems, fostering a streamlined and efficient development process.}
          \resumeItem{Implemented innovative solutions in existing PowerShell scripts, enhancing functionality and improving system performance.}
          \resumeItem{Maintained existing scripts, ensuring their continued effectiveness and updating them as necessary to meet evolving business needs.}
        \resumeItemListEnd
        {Key Achievement}
        \resumeItemListStart
          \resumeItem{Developed a PowerShell script to expedite the implementation of Security Technical Implementation Guides (STIGs) in Group Policy Objects (GPO), significantly reducing the time and effort required for this critical security task.}
        \resumeItemListEnd
...
\section{Education}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeEducationHeading
      { Cracow University of Technology}{Kraków, Poland}
      {B.Sc. in Computer Science;   \textbf{}}{Sep 2018 \textbf{--} Jun 2023}
        % \resumeItemListStart
